...
namespace PROJETO_FUP_Brasil.Controllers
{
    public class EmailsController : Controller
    {
        ...
        {
            var pROJETO_FUP_BrasilContext = _context.Email.Include(e => e.Aluno).Include(e => e.Funcionario);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Email,_Email,AlunoId,FuncionarioID")] Email email)
        {
