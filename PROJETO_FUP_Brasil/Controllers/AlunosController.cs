...
namespace PROJETO_FUP_Brasil.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id_Matricula,Nome,Rg,Cpf,Datanascimento,Genero,CursosID")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Matricula,Nome,Rg,Cpf,Datanascimento,Genero,CursosID")] Aluno aluno)
        {
